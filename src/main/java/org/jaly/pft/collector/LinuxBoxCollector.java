package org.jaly.pft.collector;

import com.jcraft.jsch.*;
import org.jaly.pft.collector.box.BoxCollector;
 ...
 * @author Jaly
 */
public class LinuxBoxCollector implements BoxCollector {
    // 获取当前系统运行情况的Linux 命令
     ...
     */
    @Override
    public Map<String, String> runDistanceShell(String[] commands, String user, String passwd, String host) {
    ...
    public static void main(String[] args) {
        BoxCollector boxCollector = new LinuxBoxCollector();
        // Map<String, String> result = boxCollector.runDistanceShell(COMMANDS, "root", "@@123", "192.168.1.233");
        // System.out.println(boxCollector.disposeResultMessage(result));
        System.out.println(boxCollector.disposeResultMessage(boxCollector.runLocalShell(COMMANDS)));
    }
