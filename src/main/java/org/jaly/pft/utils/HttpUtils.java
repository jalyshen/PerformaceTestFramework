...
public class HttpUtils {
    ...
    /**
     * @param httpUrl
     * @param needReadResponse
     * @return
     */
    public static String doGet(String httpUrl, boolean needReadResponse) {
        ...
        try {
            ...
            // 设置连接主机服务器的超时时间：15000毫秒（15秒）
            connection.setConnectTimeout(15000);
            // 设置读取远程返回的数据时间：60000毫秒（60秒）
